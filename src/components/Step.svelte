...
<div on:click={onClick} class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid
    ...
    <div class="flex-1 flex justify between gap-4 items-center">
        <div
            class="ml-auto cursor-pointer hover:text-slate-950 duration-200 relative after:absolute 
            after:top-0 after:h-0 after:right-full after:w-full after:h-full after:bg-white after:duration-200 
